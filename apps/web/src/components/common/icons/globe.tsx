...
export const GlobesIcon = ({ ...props }: SVGAttributes<SVGSVGElement>) => {
  return (
...
<path d="M8.0001 3H9.0001C7.0501 8.84 7.0501 15.16 9.0001 21H8.0001" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M3 9.00001C8.84 7.05001 15.16 7.05001 21 9.00001" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
